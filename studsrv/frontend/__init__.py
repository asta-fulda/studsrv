...
app.add_url_rule('/user/project/<name>/add', view_func = login.login_required(user.ProjectAddAdminView.as_view('user.project.admin.add')))
app.add_url_rule('/user/project/<name>/remove', view_func = login.login_required(user.ProjectRemoveAdminView.as_view('user.project.admin.remove')))
